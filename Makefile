...
install:
	...
	if which gtk-update-icon-cache 2>&1>/dev/null && test -f $(DESTDIR)$(prefix)/share/icons/hicolor/index.theme; then gtk-update-icon-cache $(DESTDIR)$(prefix)/share/icons/hicolor; fi
